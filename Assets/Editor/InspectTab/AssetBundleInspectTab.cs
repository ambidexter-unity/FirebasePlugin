...
//            }
        ...
        {
            var folderPath = Path.Combine(Application.dataPath, "Server~");
            
            var fullFolderPath = Path.Combine(System.IO.Path.GetFullPath("."), folderPath);
            
            var gamePath = System.IO.Path.GetFullPath(".");
//            Debug.Log("folderPath = " + fullFolderPath);
            var directories = Directory.GetDirectories(fullFolderPath, "*", SearchOption.AllDirectories);
            var result = new string[directories.Length + 1];
            ...
            result[directories.Length] = fullFolderPath;
            
//            foreach (var d in directories)
//            {
//                Debug.Log("dir = " + d.Replace(gamePath,""));
//            }
