...
//                    if (System.String.IsNullOrEmpty(folder.Key))
//                    {
//	                    Debug.Log("Key empty" + folder.Value);
//                        foreach(var path in folder.Value)
//                            root.AddChild(new InspectTreeItem(path, 0));
//                    }
//                    else
//                    {
////	                    Debug.Log("Key not empty" + folder.Value);
////	                    var folderItem = new TreeViewItem(folder.Key.GetHashCode(), 0, folder.Key);
//	                    var folderItem = new TreeViewItem(6, 0, folder.Key);
//                        foreach (var path in folder.Value)
//                        {
//	                        
//	                        
...
//		                        
//		                        
//		                        var newPath = path.Split('/').Skip(2).Aggregate((x, y) => x + "/" + y);
//		                        
////		                        Debug.Log("path = " + path);
...
//		                        {
//			                        folderItem.AddChild(new TreeViewItem(folder.Key.GetHashCode(), 1, newPath.Split('/').Take(1).First()));
//		                        }
//		                        else
//		                        {
//			                        folderItem.AddChild(new InspectTreeItem(path, folder.Key, 1, newPath));
//		                        }
//
//		                        
////		                        folderItem.AddChild(new InspectTreeItem(path, folder.Key, 1, prettyName));
//	                        }
//
////                            folderItem.AddChild(new TreeViewItem(path, folder.Key, 1, prettyName));
//                        }
//                        root.AddChild(folderItem);
//                    }
//				}
...
//		private TreeViewItem BuildElement(string path, int depth)
//		{
//			var folderItem = new TreeViewItem(6, 0, folder.Key);
//			foreach (var path in folder.Value)
//			{
